            ...
            <div class="space-y-6 lg:space-y-10">
                ...
                <div class="flex">
                    ...
                    <div class="ml-5 sm:ml-8">
                        ...
                        <p class="mt-1 text-gray-600 dark:text-gray-400">
                            Our documentation and extensive Client libraries contain everything a business needs to build a
                            custom integration in a fraction of the time.
                        </p>
                    </div>
                </div>
                <!-- End Icon Block -->
                ...
                <div class="flex">
                    ...
                    <div class="ml-5 sm:ml-8">
                        ...
                        <p class="mt-1 text-gray-600 dark:text-gray-400">
                            From boarding passes to movie tickets, there's pretty much nothing you can't store with storage.
                        </p>
                    </div>
                </div>
                <!-- End Icon Block -->
